...
import {base64UrlToUint8Array} from './helpers.js';
...
export class PushClient {
	constructor(stateChangeCb, subscriptionUpdate) {
		...
		this._getElement = function (selector) {
				...
				const subscription = await reg.pushManager.subscribe(
					{
						...
						applicationServerKey: base64UrlToUint8Array(this._getElement('.js-payload-textfield').value),
					},
				);
				this._stateChangeCb(this._state.SUBSCRIBED);
				this._subscriptionUpdate(subscription);
